...
ALTER TABLE `trabalho` ADD `title_stemmer` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , ADD `text_stemmer` LONGTEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ;